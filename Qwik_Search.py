...
def generate_links():
    ...
    #term1 = ["Dopamine*", "Dopamine Agents*", "Receptors, Dopamine*", "agonists:Dopamine Agonists*", "antagonists & inhibitors:Dopamine Antagonists*"]
    #term2 = ["Conditioning, Psychological*","Conditioning, Classical*","Conditioning, Fear*"]
    #save_path = "/home/lauri/Downloads/mesh2terms_ATERISKS"
    while True:
...
def get_citations(save_path):
    ...
    for link in df['URL']:
        ...
        if result != None:
            ...
            for page in range(1,max_pages+1):
                ...
                #titles = view.find_all("a",{"class":"labs-docsum-title"})
                for paper in papers:
    ...
    notebook_name = os.path.join(save_path + "_notebook.csv")
...
def count_duplicates(save_path, df, notebook):
    ...
    file_name2 = os.path.join(save_path + "_duplicates_summary.csv")
